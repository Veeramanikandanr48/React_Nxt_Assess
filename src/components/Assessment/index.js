...
class Assessment extends Component {
  ...
  endAssessment = () => {
    ...
    if (timeUp) {
      ...
      // If the assessment is completed within time, navigate to the Result Route
      ...
      const formattedTimer = `${hours.toString().padStart(2, '0')}:${(
        9 - minutes
      )
        .toString()
        .padStart(2, '0')}:${(60 - seconds).toString().padStart(2, '0')}`

      history.replace('/results', {score, formattedTimer, timeUp: false})
    }
